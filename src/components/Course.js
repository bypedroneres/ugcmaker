        ...
        <div className="Course_Content">
            <h2>*</h2>
              <h1>Estrutura da Formação</h1>
                <p>Tudo que você precisa saber, do ponto zero ao Ugc Profissional
                </p>
            <div className='Courses_Container'>
              ...
              <div className='Course_Card'>
                ...
                <h3>Ugc Thinking</h3>
                <p>Aprenda a roteirizar, filmar e editar, do melhor jeito para atrair as marcas.
                </p>
              </div>
              <div className='Course_Card'>
                <div className='Course_Card_Image'>
                ...
                <p>Assessoria exclusiva da Nora, e ainda, plataforma para alunos(as) da formação.
                </p>
              </div>
            </div>
